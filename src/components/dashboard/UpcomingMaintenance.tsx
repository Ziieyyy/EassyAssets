    ...
    <div className="glass rounded-xl p-6 animate-fade-in hover-lift hover-border group transition-all duration-300">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold text-foreground group-hover:text-primary transition-colors duration-300">Upcoming Maintainance</h3>
        </div>
        {!isLoading && (
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-sm font-medium text-muted-foreground">No upcoming maintainance</p>
          <p className="text-xs text-muted-foreground/70 mt-1">All maintainance tasks are completed</p>
        </div>
      )}
    </div>
  );
