...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "editAsset.depreciationCalcDesc": "Automatic depreciation calculation based on purchase details",
    "editAsset.depreciationMethodLabel": "Depreciation Method",
    "editAsset.straightLine": "Straight-Line",
    "editAsset.straightLineDesc": "Equal depreciation each period",
    "editAsset.decliningBalance": "Declining Balance",
    "editAsset.decliningBalanceDesc": "Higher depreciation in early years",
    "editAsset.sumOfYears": "Sum-of-Years-Digits",
    "editAsset.sumOfYearsDesc": "Accelerated depreciation",
    "editAsset.usefulLife": "Useful Life (Years)",
    "editAsset.usefulLifeAuto": "(Auto-calculated based on category)",
    "editAsset.usefulLifeDesc": "Automatically set based on asset category. You can adjust manually if needed.",
    ...
    "editAsset.notSet": "Not set",
    "editAsset.year": "year",
    "editAsset.calculationDesc": "The depreciation is calculated from the purchase date to today using the",
    "editAsset.method": "method",
  ...
  ms: {
    ...
    "editAsset.depreciationCalcDesc": "Pengiraan susut nilai automatik berdasarkan butiran pembelian",
    "editAsset.depreciationMethodLabel": "Kaedah Susut Nilai",
    "editAsset.straightLine": "Garis Lurus",
    "editAsset.straightLineDesc": "Susut nilai sama setiap tempoh",
    "editAsset.decliningBalance": "Baki Menurun",
    "editAsset.decliningBalanceDesc": "Susut nilai lebih tinggi pada tahun awal",
    "editAsset.sumOfYears": "Jumlah-Tahun-Digit",
    "editAsset.sumOfYearsDesc": "Susut nilai dipercepatkan",
    "editAsset.usefulLife": "Hayat Berguna (Tahun)",
    "editAsset.usefulLifeAuto": "(Auto-dikira berdasarkan kategori)",
    "editAsset.usefulLifeDesc": "Ditetapkan secara automatik berdasarkan kategori aset. Anda boleh laraskan secara manual jika perlu.",
    ...
    "editAsset.notSet": "Tidak ditetapkan",
    "editAsset.year": "tahun",
    "editAsset.calculationDesc": "Susut nilai dikira dari tarikh pembelian hingga hari ini menggunakan kaedah",
    "editAsset.method": "kaedah",
