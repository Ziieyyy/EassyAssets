...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "dashboard.maintenanceDue": "Maintainance",
    "dashboard.highPriority": "scheduled tasks",
    "dashboard.noHighPriority": "No scheduled tasks",
    ...
    "status.maintenance": "Maintainance",
    ...
    "editAsset.straightLineDesc": "Reduces an asset's value by the same amount each period.<br/><br/>Purchase Price ÷ Useful Life",
    ...
    "editAsset.calculationFullDesc": "Depreciation is calculated from the purchase date to today using the Straight-Line method, based on the asset's purchase price and useful life. Formula: Purchase Price ÷ Useful Life",
  ...
  ms: {
    ...
    "dashboard.maintenanceDue": "Penyelenggaraan",
    "dashboard.highPriority": "tugasan dijadualkan",
    "dashboard.noHighPriority": "Tiada tugasan dijadualkan",
    ...
    "editAsset.straightLineDesc": "Mengurangkan nilai aset dengan jumlah yang sama bagi setiap tempoh.<br/><br/>Harga Belian ÷ Hayat Berguna",
    ...
    "editAsset.calculationFullDesc": "Susut nilai dikira dari tarikh pembelian hingga hari ini menggunakan kaedah Garis Lurus, berdasarkan harga belian dan hayat berguna aset. Formula: Harga Belian ÷ Hayat Berguna",
