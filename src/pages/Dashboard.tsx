...
import { useMaintenanceCountByPriority } from "@/hooks/useMaintenance";
...
export default function Dashboard() {
  ...
  const { data: maintenanceCount } = useMaintenanceCountByPriority();
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <MetricCard
          ...
          value={(maintenanceCount?.total || 0).toString()}
          change={maintenanceCount?.high ? `${maintenanceCount.high} ${t("dashboard.highPriority")}` : t("dashboard.noHighPriority")}
          changeType={maintenanceCount?.high ? "negative" : "neutral"}
          icon={AlertTriangle}
